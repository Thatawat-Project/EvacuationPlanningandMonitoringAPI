...
public class RedisToDbSyncService : BackgroundService
{
    ...
    private readonly ILogger<RedisToDbSyncService> _logger;


    public RedisToDbSyncService(IServiceScopeFactory scopeFactory, ILogger<RedisToDbSyncService> logger)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                _logger.LogError(ex, "Sync failed during execution.");
            }
